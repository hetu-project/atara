...
const STYLE: Record<BadgeKind, { label: string; cls: string; glow: string }> = {
  ...
  validating: { label: '校验中', cls: 'text-info bg-info/12', glow: '#9fc5ff33' },
  passed: { label: '通过', cls: 'text-ok bg-ok/12', glow: '#8ee0ba33' },
  challenged: { label: '待补充', cls: 'text-warn bg-warn/12', glow: '#f1b99133' },
  declined: { label: '已拒绝', cls: 'text-bad bg-bad/12', glow: '#ffb4aa33' },
  pass: { label: '通过', cls: 'text-ok bg-ok/12', glow: '#8ee0ba33' },
  warn: { label: '警告', cls: 'text-warn bg-warn/12', glow: '#f1b99133' },
  fail: { label: '不通过', cls: 'text-bad bg-bad/12', glow: '#ffb4aa33' },
  open: { label: '待处理', cls: 'text-warn bg-warn/12', glow: '#f1b99133' },
  resolved: { label: '已处理', cls: 'text-ok bg-ok/12', glow: '#8ee0ba33' },
};
